            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('profile.edit') }}"
                    ...
                    <svg class="w-3 h-3 fill-current" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus"
                        ...
                        viewBox="0 0 448 512">
                        <path fill="currentColor" website208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32
                            website-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67
