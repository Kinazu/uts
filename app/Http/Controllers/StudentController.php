...
public function showResults()
{
    ...
    foreach ($students as $student) {
        ...
        // Calculate the final score using your function or formula
        $nilaiAkhir = hitungNilaiAkhir($nilaiHarian, $nilaiUTS, $nilaiUAS);

        // Add the calculated value to the student model
        $student->nilaiAkhir = $nilaiAkhir;
    }
